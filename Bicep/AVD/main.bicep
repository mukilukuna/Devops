...
module resourceGroupDeploy './dependencies/resourceGroup.bicep' = {
  name: 'resourceGroup'
  params: {
...
module DCR './dependencies/DCR.bicep' = {
  name: 'DCR'
...
module backPlane './dependencies/backPlane.bicep' = {
  name: 'backPlane'
...
module VMswithLA './dependencies/VMs.bicep' = {
