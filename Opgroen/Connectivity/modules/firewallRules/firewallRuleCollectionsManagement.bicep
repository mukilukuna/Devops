...
var rulecollections = loadJsonContent('../../configs/firewallRules/platformManagement.json')

module managementRuleCollections '../../../Templates/Features/AzureFirewallRuleCollection/template.bicep' = {
  name: 'managementRuleCollections-${time}'
  params: {
