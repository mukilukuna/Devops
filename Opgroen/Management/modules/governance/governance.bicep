...
var governanceSettings = subscriptionConfig.Governance
...
module securityCenter '../../../Templates/Features/SecurityCenter/template.bicep' = if (governanceSettings.enableDefenderForCloud) {
...
module defenderForCloudSettings '../../../Templates/Features/DefenderForCloudSettings/template.bicep' = if (governanceSettings.enableDefenderForCloud) {
  ...
  params: {
    ...
    email: governanceSettings.securityEmail
  }
}
