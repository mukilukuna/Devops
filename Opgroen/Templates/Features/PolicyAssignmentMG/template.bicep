...
@description('Optional. Enables deployment of a User Assgined Identity. Contains the User Identity information')
@secure()
...
resource policyAssignments 'Microsoft.Authorization/policyAssignments@2021-06-01' = {
  ...
  location: location
  properties: {
    displayName: '${mgInfo.properties.displayName} - ${displayName}'
