...
module PolicyExemptionMG 'br/BicepFeatures:policyexemptionmg:v1.0.0' = {
  name: 'PolicyExemptionMG-${time}'
  params: {
    name: name
...
output resourceName string = PolicyExemptionMG.outputs.resourceName
@description('The resource-id of the Azure resource')
output resourceID string = PolicyExemptionMG.outputs.resourceID
