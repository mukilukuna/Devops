...
# Customizations
[System.Object]$Enrollmentaccounts = @("mdm@koers.com", "its_admin@koers.com", "its_test@koers.com" ) # @() = No Enrollment accounts. @("wds@tbone.se","wds2@tbone.se") = will filter them out and not assign them as primary users.
...
function Invoke-ConnectMgGraph {
    ...
    End {
        #Cleanup memory after connecting to Graph
