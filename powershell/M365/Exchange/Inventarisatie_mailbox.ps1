...
$path = "C:\Users\MukiLukunaITSynergy\IT Synergy\Aurora Group B.V. - Documents\General\Professional Services\Project - Online Werkplek\Inventarisatie Fase\mailbox.CSV"
